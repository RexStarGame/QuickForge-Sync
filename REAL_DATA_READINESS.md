...
- More failure testing for corrupted cloud vault files
- Clear emergency backup guidance in the app
- More UI polish around recovery and account switching
...
The app is closer to real-data readiness, but it should remain a beta preview until the checklist above is complete.
